...
export type PostSnippetFragment = (
  { __typename?: 'Post' }
  & Pick<Post, 'id' | 'createdAt' | 'updatedAt' | 'points' | 'textSnippet' | 'voteStatus'>
  & {
    creator: (
      { __typename?: 'User' }
...
export type CreatePostMutation = (
  ...
  & {
    createPost: (
      { __typename?: 'Post' }
      & Pick<Post, 'id' | 'createdAt' | 'updatedAt' | 'text' | 'points' | 'creatorId'>
    )
  }
);
...
export type PostQuery = (
  ...
  & {
    post?: Maybe<(
      { __typename?: 'Post' }
      & Pick<Post, 'id' | 'createdAt' | 'updatedAt' | 'points' | 'text' | 'voteStatus'>
      & {
        creator: (
          { __typename?: 'User' }
          & Pick<User, 'id' | 'username'>
